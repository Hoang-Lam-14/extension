chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  let isCodeInSource = findSubizScriptTag()

  sendResponse({
    subiz_code_in_source: isCodeInSource,
...
function isEmbededCodeValid (str = '') {
  return str.indexOf('!function(') > -1 && str.indexOf('s,u,b,i,z') > -1 && str.indexOf('setAccount') > -1 && str.indexOf('_subiz_init_') > -1
}
